...
export default function Card({
  ...
  return (
    <div
      className={`rounded-lg p-32 shadow-[40px_60px_50px_-47px_rgba(72,85,106,0.24)] ${cardColors[className]} ${gridProperties[className]} ${className === "card1" ? "md:bg-[url(./src/assets/images/bg-pattern-quotation.svg)] md:bg-[85%_0%] md:bg-no-repeat" : ""}`}
    >
